...
create table if not exists public.app_state(id integer primary key check(id=1),version bigint not null default 0,state jsonb not null default '{"clients":[],"trips":[],"sales":[],"settings":{"company":"Rota Viva Excursões","owner":"Magno Jorge de Castro Nascimento","ownerCpf":"804.914.801-72","phone":"","email":"","address":"","reservationPrefix":"RV","lastReservation":0}}'::jsonb);
